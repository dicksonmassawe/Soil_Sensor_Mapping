...
constexpr char WIFI_SSID[] = "EPAL-PUBLIC";
constexpr char WIFI_PASSWORD[] = "epal1234";

// See https://thingsboard.io/docs/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] = "gvbo47k0dlwlcne29ve6";

// Thingsboard we want to establish a connection too
constexpr char THINGSBOARD_SERVER[] = "10.10.94.18:9090";
